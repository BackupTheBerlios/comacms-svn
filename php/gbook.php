...
if($input == "true")
{
	...
	if($gb_mail != "")
	{
		if(!eregi("^[a-z0-9\._-]+@+[a-z0-9\._-]+\.+[a-z]{2,4}$", $gb_mail))
			$error .= "<li class=\"error\">Die Email-Adresse ist ungültig.</li>\n";	 
	}
	if($gb_icq != "")
	{
		if(!eregi("^[0-9]{3}(\-)?[0-9]{3}(\-)?[0-9]{3}$", $gb_icq))
...
$text = "<div class=\"gbook\"><div class=\"error\">$error</div>
<form method=\"post\" action=\"index.php?site=".$_site."\">
<input type=\"hidden\" name=\"input\" value=\"true\" />
<table class=\"gbook\">
<tr><td><label>Name:</label></td>
<td><input type=\"text\" name=\"gb_name\" value=\"".$gb_name."\" /></td></tr>
<tr><td><label>Email:</label></td>
<td><input type=\"text\" name=\"gb_mail\" value=\"".$gb_mail."\" /></td></tr>
<tr><td><label>ICQ:</label></td>
<td><input type=\"text\" name=\"gb_icq\" value=\"".$gb_icq."\" /></td></tr>
<tr><td><label>Homepage:</label></td>
<td><input type=\"text\" name=\"gb_homepage\" value=\"".$gb_homepage."\" /></td></tr>
<tr><td><label>Nachricht:</label></td>
<td><textarea name=\"gb_text\">$gb_text</textarea></td></tr>
<tr><td><input type=\"reset\" value=\"Zurücksetzen\" class=\"button\" /></td><td><input class=\"button\" type=\"submit\" value=\"Eintragen\" /></td></tr>
</table>
</form>
</div>";
...
while($row = mysql_fetch_object($result))
{
 ...
 if($row->icq != "")
 {
	$text .= "<span class=\"gb_content_info_icq\"><a href=\"http://wwp.icq.com/scripts/search.dll?to=".$row->icq."\" target=\"_blank\"><img width=\"18\"  height=\"18\" class=\"gb_content_info_icq\" src=\"http://status.icq.com/online.gif?icq=".$row->icq."&amp;img=5\" alt=\"ICQ-Status\"/></a></span>";
 }
 if($row->homepage != "")
 {
 	$text .= "<span class=\"gb_content_info_homepage\"><a href=\"http://".$row->homepage."\">Homepage</a></span>";
 }
 $text .= "</div>\n";
  $time = date("H:i:s",$row->date);
 if($time == "00:00:00")
 	$time ="";
 $text .= "<div class=\"gb_content_text\">".replace_smilies(nl2br(htmlspecialchars($row->message)))."<div class=\"gb_content_date\">".date("d.m.Y",$row->date)."&nbsp;".$time."</div></div></div>\n\n\n";
