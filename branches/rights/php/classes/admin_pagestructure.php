 	...
 	class Admin_PageStructure {
		...
		function _inlineMenu() {
			...
			<table>
				...
				<tr>
					<td>&nbsp;</td><td><a href=\"admin.php?page=pagestructure&amp;action=inlinemenu&amp;page_id=$page_id&amp;action2=select_image\" class=\"button\">Bild ausw�hlen/ver�ndern</a></td>
				</tr>
			</table>";
				$sql = "SELECT *
					FROM " . DB_PREFIX ."inlinemenu_entries
				...
				$out .= "</table>
					<a href=\"admin.php?page=pagestructure&amp;action=inlinemenu&amp;page_id=$page_id&amp;action2=add_new_dialog\" class=\"button\">Einen Eintrag hinzuf�gen</a>";
			}
			return $out;
		}
