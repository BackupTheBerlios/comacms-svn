...
if($error == "" && $input == "true"){
	...
	<tr><td>Mail:</td><td>".$contact_mail."</td></tr>
	<tr><td>ICQ:</td><td>".$contact_icq."</td></tr>
	<tr><td>Homepage:</td><td>".$contact_homepage."</td></tr>
	<tr><td>Text:</td><td>".nl2br($contact_text)."</td></tr>
	<tr><td>Datum:</td><td>".date("d.m.Y H:i:s",mktime())."</td></tr>
	<tr><td>IP:</td><td>".$REMOTE_ADDR."</td></tr>
	<tr><td>Host:</td><td>".gethostbyaddr($REMOTE_ADDR)."</td></tr>
	</table>
	</body>
	</html>";
...
<td><input type=\"text\" name=\"contact_name\" value=\"".$contact_name."\" /></td></tr>
<tr><td><label>Email:</label></td>
<td><input type=\"text\" name=\"contact_mail\" value=\"".$contact_mail."\" /></td></tr>
<tr><td><label>ICQ:</label></td>
<td><input type=\"text\" name=\"contact_icq\" value=\"".$contact_icq."\" /></td></tr>
<tr><td><label>Homepage:</label></td>
<td><input type=\"text\" name=\"contact_homepage\" value=\"".$contact_homepage."\" /></td></tr>
<tr><td><label>Nachricht:</label></td>
<td><textarea name=\"contact_text\">$contact_text</textarea></td></tr>
<tr><td><input type=\"reset\" value=\"Zurücksetzen\" class=\"button\" /></td><td><input class=\"button\" type=\"submit\" value=\"Absenden\" /></td></tr>
</table>
</form>
</div>";
